...
urlpatterns +=[
    ...
    path('doctor-patients/update/<int:pk>', views.doctor_update_patient_view, name='doctor-update-patient'),
...
#--------- API ENDPOINTS (LOGIN, LOGOUT, PATIENT RECORD)-------------------------------------
urlpatterns +=[
...
# Serving media files during development (for DEBUG=True)
if settings.DEBUG:
